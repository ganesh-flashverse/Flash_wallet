...
const roles = ["Receptionist & Front Desk Manager", "Manager", "Accountant", "Staff"];
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-4 border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
          <div className="flex flex-col">
            ...
            <input className="w-full border rounded px-2 py-1 text-xs" defaultValue="Ronnie" />
          </div>
          <div className="flex flex-col">
            <label className="text-xs text-gray-500 mb-1">Last name <span className="text-red-500">*</span></label>
            <input className="w-full border rounded px-2 py-1 text-xs" defaultValue="Dickson" />
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
          <div className="flex flex-col">
            <label className="text-xs text-gray-500 mb-1">Zone <span className="text-red-500">*</span></label>
            <select className="w-full border rounded px-2 py-1 text-xs" defaultValue="All">
          ...
          <div className="flex flex-col">
            ...
            <select className="w-full border rounded px-2 py-1 text-xs" defaultValue="Receptionist & Front Desk Manager">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2 items-end">
          <div className="flex flex-col">
            ...
            <input className="w-full border rounded px-2 py-1 text-xs" defaultValue="01737000011" />
          </div>
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              <div className="flex flex-col items-center justify-center w-20 h-20 bg-gray-100 rounded border border-dashed border-gray-300 overflow-hidden">
                {/* Avatar image */}
                <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="avatar" className="w-16 h-16 object-cover rounded-full" />
              </div>
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-4 border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
          <div className="flex flex-col">
            ...
            <input className="w-full border rounded px-2 py-1 text-xs" defaultValue="Dickson@gmail.com" />
          </div>
          <div className="flex flex-col">
