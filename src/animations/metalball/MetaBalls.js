...
// Function to parse hex color into RGB components
...
// Hash functions for generating pseudo-random numbers
function hash31(p) {
...
const MetaBalls = ({
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < effectiveBallCount; i++) {
      ...
      // Increased baseScale for larger balls
      const baseScale = 10.0 + h1[1] * (20.0 - 10.0);
      const h2 = hash33(h1);
      const toggle = Math.floor(h2[0] * 2.0);
      // Increased radiusVal for larger balls
      const radiusVal = 1.0 + h2[2] * (3.0 - 1.0);
